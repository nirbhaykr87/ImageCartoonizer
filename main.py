...
img= read_img('./img1.jpg')
line_width= 9
blur_value=7
totalColor=4

edgeImg=edge_detection(img,line_width,blur_value)
img=color_quantisation(img,totalColor)
# blured = cv2.bilateralFilter(img,d=7, sigmaColor=200,sigmaSpace=200)
blured = cv2.bilateralFilter(img,7, 200,200)
